...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {state_value[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {state_value[0]}]
set_property PACKAGE_PIN E19 [get_ports {state_value[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {state_value[1]}]
set_property PACKAGE_PIN U19 [get_ports {state_value[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {state_value[2]}]
...
set_property PACKAGE_PIN N3 [get_ports {X_out[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {X_out[0]}]
set_property PACKAGE_PIN P1 [get_ports {X_out[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {X_out[1]}]
set_property PACKAGE_PIN L1 [get_ports {X_out[2]}]					
...
set_property PACKAGE_PIN T18 [get_ports button4]						
...
set_property PACKAGE_PIN U17 [get_ports button0]						
...
##Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {motor[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {motor[2]}]
##Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {motor[3]}]					
